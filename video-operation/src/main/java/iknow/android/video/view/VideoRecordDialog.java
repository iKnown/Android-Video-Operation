...
import iknow.android.video.interfaces.onRecordFinishListener;
import iknow.android.video.widget.VideoRecorderView;
 ...
 * Describe:
 */
public class VideoRecordDialog {
    ...
    public VideoRecordDialog(final Context context) {
        this.mContext = context;
    }

    public VideoRecordDialog build(final IShortVideo iShortVideo){
        this.mCallBack = iShortVideo;
        mDialog = new Dialog(mContext,R.style.DialogStyle);
        View view = LayoutInflater.from(mContext).inflate(R.layout.video_record_layout,null);
